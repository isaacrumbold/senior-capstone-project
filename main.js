...
//using autocomplete function to recomend plants to the user.
...
function clear() {
    ...
    if (response == true) {
        selectedPlants = [];
        (_a = document.getElementById('selected-plants')) === null || _a === void 0 ? void 0 : _a.remove();
        let newDiv = document.createElement('div');
        newDiv.id = 'selected-plants';
        (_b = document.getElementById('plant-search-area')) === null || _b === void 0 ? void 0 : _b.appendChild(newDiv);
        (_c = document.getElementById('plant-search')) === null || _c === void 0 ? void 0 : _c.value = '';
        console.log('cleared');
    }
    else {
        return null;
...
function search() {
    ...
    let result = ph.search(searchWord);
    ...
    if (result == null) {
        ...
        //will execute if plant isnt in selectedPlants array
        ...
        (_a = document.getElementById('selected-plants')) === null || _a === void 0 ? void 0 : _a.appendChild(newDiv);
        console.log(selectedPlants);
        (_b = document.getElementById('plant-search')) === null || _b === void 0 ? void 0 : _b.value = '';
...
function nutrientChart() {
    ...
    if (dataArr == null) {
        ...
        ctx2.id = 'ph-chart';
        container2 === null || container2 === void 0 ? void 0 : container2.appendChild(ctx2);
        ...
        container1 === null || container1 === void 0 ? void 0 : container1.appendChild(ctx);
        ...
        // using hcart.js to create a bar chart
        new Chart(ctx, {
            type: 'bar',
            data: {
